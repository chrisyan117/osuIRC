...
namespace osu__IRC
{
    static class Languages
    {
        ...
        public static Dictionary<string, string> languageContent = new Dictionary<string, string>()
        {
            ...
            {"FRA_Message_Help_2a","/join <Channel>"},
            {"FRA_Message_Help_2b"," Rejoint un canal [ Exemple: /join #osu ]"},
            {"FRA_Message_Help_3a","/part <Channel>"},
            ...
            {"FRA_Message_Command_join_Empty_Parameter","/join <Channel>"},
            {"FRA_Message_Command_part_Empty_Parameter","/part <Channel>"},
